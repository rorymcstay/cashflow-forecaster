...
COLUMNS = [
    ...
    ("Effective Until", lambda b: b.effective_until.strftime("%d %b %Y") if b.effective_until else "—",
...
class BudgetItemsScreen(CrudScreen):
    def __init__(self, session: Session, on_change=None, parent=None):
        super().__init__(session, "Budget Items", COLUMNS, query_budget_items, BudgetItemDialog,
